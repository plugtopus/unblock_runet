...
{ // Private namespace starts.
  ...
  const setPacScriptFromProviderAsync = async function setPacScriptFromProviderAsync(
    ...
    if (provider.label === 'Выключить блокировки') {
  ...
  window.apis.antiCensorRu = {
    ...
    pacProviders: {
      ...
      Выключить_блокировки: {
        label: 'Выключить блокировки',
  ...
  "https://anticensorship-russia.tk/generated-pac-scripts/anticensority.pac"
    ...
    _currentPacProviderKey: 'Выключить_блокировки',
